...
QT_MOC_LITERAL(6, 49, 11) // "ModelUpdate"

    },
    "ExpectedWorks\0updateWork\0\0id\0nContent\0"
    "deleteWork\0ModelUpdate"
};
...
void ExpectedWorks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ExpectedWorks *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
